...
func RandomString(len int) string {
 ...
 var glb_pool map[string] string
...
func my1task(sec_wait int ) {
    glb_pool = make (map[string] string)
      CreateTable()
      if isEnable() == false {
